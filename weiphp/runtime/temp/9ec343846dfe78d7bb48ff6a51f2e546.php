<?php /*a:2:{s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin/view/config/group.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin\view\publics\base.html";i:1564394434;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
	...
	<form action="<?php echo U('save'); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<select name="<?php echo htmlentities($config['name']); ?>">
				<?php $_result=parse_field_attr($config['extra']);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
