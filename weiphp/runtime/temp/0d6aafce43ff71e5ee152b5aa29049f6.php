...
<script type="text/javascript" src="/weiphp/public/static/bdMap.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript">
$(function() {
    initUploadImg();
    initUploadFile();
