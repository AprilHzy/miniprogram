<?php /*a:7:{s:108:"D:\program\xampp\htdocs\weiphp5.0-master\application\database_dictionary\view\database_dictionary\lists.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\common.html";i:1564394434;s:79:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\head.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\header.html";i:1564394434;s:79:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\_nav.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\footer.html";i:1564394434;s:78:"D:\program\xampp\htdocs\weiphp5.0-master\application\common\view\base\var.html";i:1564394434;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="UTF-8" />
...
<?php endif; ?> 
      ...
      <div class="data-table">
      	<?php if(is_array($tree) || $tree instanceof \think\Collection || $tree instanceof \think\Paginator): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?>
      	# <?php echo htmlentities($key); ?><br/>
        <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?>
        <div style=" margin: 20px;"><?php echo htmlentities($key); ?>&nbsp;&nbsp;&nbsp;<?php if(isset($tables[$key])) echo $tables[$key]; ?></div>
          <div class="table-striped">
            <table cellspacing="1">
              ...
              <!-- 列表 -->
              <tbody>
                <?php if(is_array($table) || $table instanceof \think\Collection || $table instanceof \think\Paginator): $i = 0; $__LIST__ = $table;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;?>
                  <tr>
                    <td><?php echo htmlentities($field['COLUMN_NAME']); ?></td>
                    <td><?php echo htmlentities($field['COLUMN_TYPE']); ?></td>
                    <td><?php echo htmlentities($field['COLUMN_DEFAULT']); ?></td>
                    <td><?php echo htmlentities($field['IS_NULLABLE']); ?></td>
                    <td><?php echo htmlentities($field['COLUMN_COMMENT']); ?></td>
                  </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
              </tbody>
            </table>
