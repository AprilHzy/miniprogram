            ...
            <form action="<?php echo U('config'); ?>" class="form-horizontal" method="post">
                ...
                <div class="form-group row">
                    ...
                    $("#upload_file_<?php echo htmlentities($o_key); ?>").uploadify({
                        "height": 30,
                        "swf": "/weiphp5.0-master/public/static/uploadify/uploadify.swf",
...
function playSound(id,obj){
    ...
    if(audio.paused){
        audio.play();
        $(obj).find('img').attr('src','/weiphp5.0-master/public/static/base/images/icon_sound_play.gif');
        audio.addEventListener('ended', function () {
// 			alert('over');
            $(obj).find('img').attr('src','/weiphp5.0-master/public/static/base/images/icon_sound.png');
        }, false);
        return;
    }else{
        audio.pause();
