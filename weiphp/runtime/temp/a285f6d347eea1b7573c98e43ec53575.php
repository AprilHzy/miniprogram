<?php /*a:2:{s:70:"D:\program\xampp\htdocs\weiphp\application\admin\view\apps\create.html";i:1564394434;s:71:"D:\program\xampp\htdocs\weiphp\application\admin\view\publics\base.html";i:1564394434;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
...
<link rel="stylesheet" href="/weiphp/public/admin/js/codemirror/codemirror.css">
<style>
    ...
    #preview_window.loading {
        background: url('/weiphp/public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
    }
...
<script type="text/javascript" src="/weiphp/public/admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp/public/admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp/public/admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp/public/admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp/public/admin/js/codemirror/php.js?v=<?php echo SITE_VERSION; ?>"></script>

<script type="text/javascript" src="/weiphp/public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION; ?>"></script>
