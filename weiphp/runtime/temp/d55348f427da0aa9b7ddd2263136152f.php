        ...
        <div class="table-bar">
            ...
            <form class="muti_search cf" action="<?php echo htmlentities((isset($search_url) && ($search_url !== '')?$search_url:'')); ?>" method="get">
                <div style="line-height: 30px;">
                    ...
                    <span>至</span>
                    <input type="datetime" autocomplete="off" name="end_time" class="search-input date input-small" value="<?php echo htmlentities($vo['end_time']); ?>" placeholder="请选择时间"> <?php break; case "checkbox": ?>
...
<link href="/weiphp5.0-master/public/static/datetimepicker/css/datetimepicker.css?v=<?php echo SITE_VERSION; ?>" rel="stylesheet" type="text/css"> <?php if(config('COLOR_STYLE')=='blue_color') echo '
