<?php /*a:2:{s:80:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin\view\apps\create.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin\view\publics\base.html";i:1564394434;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
...
<link rel="stylesheet" href="/weiphp5.0-master/public/admin/js/codemirror/codemirror.css">
<style>
    ...
    #preview_window.loading {
        background: url('/weiphp5.0-master/public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
    }
...
<script type="text/javascript" src="/weiphp5.0-master/public/admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp5.0-master/public/admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp5.0-master/public/admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp5.0-master/public/admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION; ?>"></script>
<script type="text/javascript" src="/weiphp5.0-master/public/admin/js/codemirror/php.js?v=<?php echo SITE_VERSION; ?>"></script>

<script type="text/javascript" src="/weiphp5.0-master/public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION; ?>"></script>
