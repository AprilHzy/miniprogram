<?php /*a:2:{s:79:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin\view\menu\lists.html";i:1564394434;s:81:"D:\program\xampp\htdocs\weiphp5.0-master\application\admin\view\publics\base.html";i:1564394434;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
...
<body <?php if(empty($top_menu['core_side_menu']) || (($top_menu['core_side_menu'] instanceof \think\Collection || $top_menu['core_side_menu'] instanceof \think\Paginator ) && $top_menu['core_side_menu']->isEmpty())): ?>style="padding-left:0;"<?php endif; ?>>
    ...
    <div class="main-title">
        <h2><?php echo htmlentities($nav_title); ?>菜单管理</h2>
    </div>
	<div class="cf">
		<div class="fl">
		<?php if(empty($model['extend']) || (($model['extend'] instanceof \think\Collection || $model['extend'] instanceof \think\Paginator ) && $model['extend']->isEmpty())): ?>
			<div class="tools">
				<?php  $add_url = U('add',array('uid'=>input('uid'))); ?><a class="btn" href="<?php echo htmlentities($add_url); ?>">新 增</a>
				<?php  $del_url = U('del',array('uid'=>input('uid'))); ?><button class="btn ajax-post confirm" target-form="ids" url="<?php echo htmlentities($del_url); ?>">删 除</button>
			</div>
		<?php endif; ?>
		</div>
            ...
            <table>
                ...
                <thead>
                    <tr>
                        ...
                        </th><?php endif; if(isset($list_grids)){ if(is_array($list_grids) || $list_grids instanceof \think\Collection || $list_grids instanceof \think\Paginator): $i = 0; $__LIST__ = $list_grids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;?>
