...
`wpid`  int(10) NULL  COMMENT 'shop_id',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`param_name`  varchar(30) NULL  COMMENT '参数名',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`enable`  char(10) NULL  DEFAULT 1 COMMENT '是否启用',
`branch_id`  varchar(255) NULL  COMMENT '授权门店',
`ctime`  int(10) NULL  COMMENT '创建时间',
`wpid`  int(10) NULL  COMMENT 'wpid',
`fans_gift_money`  decimal(10,2) NULL  DEFAULT 0 COMMENT '转发增粉奖励金额',
...
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`cashout_amount`  float NULL  COMMENT '提现金额',
...
`refund_content`  varchar(255) NULL  COMMENT '退款原因',
...
`distribution_price`  decimal(10,2) NULL  COMMENT '分销返佣金额',
`is_spec`  int(10) NULL  DEFAULT 0 COMMENT '是否有规格',
`file_url`  varchar(255) NULL  COMMENT '文件下载链接',
`express`  decimal(10,2) NULL  DEFAULT 0 COMMENT '邮费',
...
`param_temp_id`  int(11) NULL  COMMENT '参数模板ID',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`custom_tip`  text NULL  COMMENT '联系客服提示内容',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`money`  decimal(10,2) NULL  COMMENT '现在开关',
`money_param`  decimal(10,2) NULL  COMMENT '现金参数',
...
`coupon_param`  int(10) NULL  COMMENT '优惠券ID',
`sort`  int(10) NULL  DEFAULT 0 COMMENT '排序号',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`market_price`  decimal(10,2) NULL  DEFAULT 0 COMMENT '原价',
`sale_price`  decimal(10,2) NULL  DEFAULT 0 COMMENT '销售价',
`shop_goods_id`  int(10) NULL  COMMENT '商城商品',
`del_at`  int(10) NULL  DEFAULT 0 COMMENT '删除时间',
`stock_id`  int(10) unsigned NOT NULL  COMMENT '主键，不使用id主要是方便与goods表联系查询不产生id覆盖报错',
PRIMARY KEY (`id`),
